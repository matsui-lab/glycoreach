...
test_that("compute_reachability returns all 22 metrics for 'all'", {
  ...
  all_genes <- c(
    ...
    "EXT1", "NDST1", "HS2ST1", "HS6ST1", "HS3ST1",
    "ALG1", "STT3A", "MAN1A1", "MGAT1", "MAN2A1", "MGAT2",
  ...
  expected_metrics <- c("sLeX_reachability", "GM3_reach", "GM1_reach", "GD3_reach",
